...
contextBridge.exposeInMainWorld('api', {
  ...
  exportDiary: (dates) => ipcRenderer.invoke('diary:export', dates),
  importDiary: () => ipcRenderer.invoke('diary:import'),
  openMain: () => ipcRenderer.invoke('app:open-main'),
  openExportWindow: () => ipcRenderer.invoke('app:open-export-window'),
  closeExportWindow: () => ipcRenderer.invoke('app:close-export-window'),
